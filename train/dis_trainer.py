...
class DisTrainer(TrainerBase):
    def __init__(self, config, model, tokenizer):
        ...
        self.model = model
        self.train_dataloader = load_dataloader(config, tokenizer, 'dis_train', shuffle=True)
        self.valid_dataloader = load_dataloader(config, tokenizer, 'dis_valid', shuffle=True)
